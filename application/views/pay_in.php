                ...
                <div class="container-fluid">
                    <div class="d-flex justify-content-between">
                        <div class="top-menu d-flex align-items-center">
                            ...
                            <button type="button" id="back" onclick="history.back();" class="nav-link"><i class="ik ik-chevron-left"></i></button>
            ...
            <div class="page-wrap">
                ...
                <div class="main-content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card">
                           <div class="card-body">
                                        <form action='<?php echo base_url('index.php/main/pay')?>' method='post' class="forms-sample">
